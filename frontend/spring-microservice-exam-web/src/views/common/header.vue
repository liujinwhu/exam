              ...
              <div class="classynav">
                ...
                <el-menu :default-active="activeIndex"
                  ...
                  <el-submenu index="/u">
                    ...
                    <el-menu-item index="u-deploy" @click="open('https://www.kancloud.cn/Uncle Lan/spring-microservice-exam/1322870')">
                      部署文档
                    </el-menu-item>
                    <el-menu-item index="c-log" @click="open('https://gitee.com/wells2333/spring-microservice-exam/blob/master/CHANGELOG.md')">
                      更新日志
                    </el-menu-item>
                    <el-menu-item index="c-overview"  @click="open('https://www.kancloud.cn/Uncle Lan/spring-microservice-exam/1322864#6__112')">
                      规划总览
                    </el-menu-item>
