package com.lanshu.common.log.aspect;

import com.lanshu.common.core.utils.SpringContextHolder;
import com.lanshu.common.log.annotation.Log;
import com.lanshu.common.log.event.LogEvent;
import com.lanshu.common.log.utils.LogUtil;
...
public class LogAspect {
    ...
    public Object around(ProceedingJoinPoint point, Log log) throws Throwable {
        ...
        com.lanshu.common.basic.model.Log logVo = LogUtil.getLog();
